...
export type HeroKey = Exclude<keyof Heroes, 'generic_data_type'>;
...
export let cachedCharacters: HeroWithKey[] | null = null;
export let cachedItems: Upgrade_with_name[] | null = null;
